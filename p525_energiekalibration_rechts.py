...
output_filename = "D:/david/Documents/Physik/FS 6 P5/P5/525/David/figs/energiekalibration_rechts.pdf"

source_filename = "energiekalibration_rechts.txt"

xlabel = "$E/$keV"
ylabel = "Kanäle"
title = "Energiekalibration mit $^{133}$Ba- und $^{22}$Na-Spektrum"
...
for x in lines:
    channel.append(float(x.split()[0]))
    dchannel.append(float(x.split()[1]))
data.close()
